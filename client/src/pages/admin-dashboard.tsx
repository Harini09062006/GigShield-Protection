...
export default function AdminDashboard() {
  ...
  return (
    <Layout>
      ...
      {/* System Status */}
      <Card className="mb-8 rounded-3xl p-8 bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-4 rounded-lg bg-blue-50 border border-blue-200">
            <p className="text-xs text-muted-foreground font-semibold mb-1">Weather Data Source</p>
          ...
          <div className="p-4 rounded-lg bg-purple-50 border border-purple-200">
            ...
            <p className="text-sm font-bold text-purple-600">Predictive Model</p>
            <span className="inline-block mt-2 px-2 py-1 text-xs font-semibold bg-green-100 text-green-700 rounded">✓ Active</span>
          </div>
